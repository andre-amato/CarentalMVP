...
describe('GetAllBookingsUseCase', () => {
  ...
  beforeEach(() => {
    ...
    getAllBookingsUseCase = new GetAllBookingsUseCase(mockBookingRepository);
  });
  ...
  it('should return all bookings', async () => {
    ...
    mockBookingRepository.findAll.mockResolvedValueOnce(mockBookings);
  ...
  it('should return empty array when no bookings exist', async () => {
    mockBookingRepository.findAll.mockResolvedValueOnce([]);
